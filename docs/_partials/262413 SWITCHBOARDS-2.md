...
3. Transient voltage suppression devices.
4. Disconnecting and overcurrent protective devices.
5. Instrumentation.
6. Control power.
7. Accessory components and features.
8. Identification.
9. Mimic bus.
10. ACTION SUBMITTALS
    1. Product Data:
...
11. Include dimensioned plans, elevations, sections, and details, including required clearances and service space around equipment. Show tabulations of installed devices, equipment features, and ratings.
12. Detail enclosure types for types other than NEMA 250, Type 3R.
13. Detail bus configuration, current, and voltage ratings.
14. Detail short-circuit current rating of switchboards and overcurrent protective devices.
15. Include descriptive documentation of optional barriers specified for electrical insulation and isolation.
16. Detail features, characteristics, ratings, and factory settings of individual overcurrent protective devices and auxiliary components.
17. Include schematic and wiring diagrams for power, signal, and control wiring.
18. INFORMATIONAL SUBMITTALS
    1. Qualification Data:
       1. For qualified Installer.
    1. Field Quality-Control Reports:
       1. Test procedures used.
19. Test results that comply with requirements.
20. Results of failed tests and corrective action taken to achieve test results that comply with requirements.
21. CLOSEOUT SUBMITTALS
...
22. Manufacturer's written instructions for testing and adjusting overcurrent protective devices.
23. Time-current coordination curves for each type and rating of overcurrent protective device included in switchboards. Submit on translucent log-log graft paper; include selectable ranges for each type of overcurrent protective device.
...
25. Testing Agency's Field Supervisor:
...
28. Altitude not exceeding 6800 feet.
...
29. Indicate method of providing temporary electric service.
30. Do not proceed with interruption of electric service without Owner's written permission.
31. Comply with NFPA 70E.
32. COORDINATION
...
4. Branch Devices:
   1. Fixed mounted.
5. Sections front and rear aligned. C. Nominal System Voltage:
...
8. Phase- and Neutral-Bus Material:
...
9. Phase- and Neutral-Bus Material:
...
12. Main Phase Buses and Equipment Ground Buses:
...
13. Neutral Buses:
    1. 50 percent of the ampacity of phase buses unless otherwise indicated, equipped with mechanical connectors for outgoing circuit neutral cables. Brace bus extensions for busway feeder neutral bus.
14. Isolation Barrier Access Provisions:
...
15. TRANSIENT VOLTAGE SUPPRESSION DEVICES
    1. Manufacturers:
       1. Subject to compliance with requirements, provide products by one of the following:
       1. [Eaton Electrical Inc.; Cutler-Hammer Business Unit.](http://www.specagent.com/LookUp/?uid=123456817986&mf=04&src=wd)
16. [General Electric Company; GE Consumer & Industrial - Electrical Distribution.](http://www.specagent.com/LookUp/?uid=123456817987&mf=04&src=wd)
17. [Current](http://www.specagent.com/LookUp/?uid=123456803126&mf=04&src=wd) Technology.
...
18. Fabrication using bolted compression lugs for internal wiring.
19. Integral disconnect switch.
20. Redundant suppression circuits.
21. Redundant replaceable modules.
22. Arrangement with wire connections to phase buses, neutral bus, and ground bus.
23. LED indicator lights for power and protection status.
24. Audible alarm, with silencing switch, to indicate when protection has failed.
25. Form-C contacts rated at 5 A and 250-V ac, one normally open and one normally closed, for remote monitoring of system operation. Contacts shall reverse position on failure of
...
26. Line to Ground:
    1. 800 V for 480Y/277.
27. Neutral to Ground:
    1. 800 V for 480Y/277.
28. DISCONNECTING AND OVERCURRENT PROTECTIVE DEVICES A. Fuses are specified in Section 262813 "Fuses."
    1. Fused Switch:
...
29. INSTRUMENTATION
    1. Multifunction Digital-Metering Monitor:
       ...
       1. Phase-to-Phase Voltages, Three Phase:
          1. Plus or minus 1 percent. c. Phase-to-Neutral Voltages, Three Phase:
...
2. INSTALLATION
   ...
   1. Equipment Mounting: 1. Install switchboards on concrete base, 12-inch nominal thickness.
...
6. Install anchor bolts to elevations required for proper attachment to switchboards.
...
7. Set field-adjustable switches and circuit-breaker trip ranges. G. Install spare-fuse cabinet.
...
10. Manufacturer's Field Service:
...
11. Test continuity of each circuit.
    1. Tests and Inspections:
       1. Perform each visual and mechanical inspection and electrical test stated in NETA Acceptance Testing Specification. Certify compliance with test parameters.
12. Correct malfunctioning units on-site, where possible, and retest to demonstrate compliance; otherwise, replace with new units and retest.
13. Perform the following infrared scan tests and inspections and prepare reports:
