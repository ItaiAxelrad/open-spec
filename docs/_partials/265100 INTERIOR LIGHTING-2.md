...
1. Lighting fixtures mounted on exterior building surfaces.
...
1. SUBMITTALS
1. Product Data: 1. For each type of lighting fixture scheduled, arranged in order of fixture designation. Include data on features, accessories, finishes, and the following:
   #19205.00
1. INTERIOR LIGHTING
1. 26 51 00 - 1
...
1. Emergency lighting unit battery and charger.
1. Fluorescent and high-intensity-discharge ballasts.
1. LED lighting.
1. Lamps.
   1. Shop Drawings:
...
1. Warranty Period: 1. 5 years from date of Substantial Completion. Full warranty shall apply for first year, and prorated warranty for the remaining four years.
   1. Special Warranty for Fluorescent Ballasts: 1. Manufacturer's standard form in which ballast manufacturer agrees to repair or replace ballasts that fail in materials or workmanship within specified warranty period.
      #17041.00
   1. INTERIOR LIGHTING
   1. 26 51 00 - 2
   1. EG Power Engineering
...
1. FIXTURES AND COMPONENTS, GENERAL
1. Recessed Fixtures:
...
1. Incandescent Fixtures: 1. Comply with UL 1598. Where LER is specified, test according to
   NEMA LE 5A.
...
1. Specular Surfaces:
   1. 83 percent.
1. Diffusing Specular Surfaces:
   1. 75 percent.
1. Laminated Silver Metallized Film:
...
4. Electronic ballasts for linear lamps shall include the following features, unless otherwise indicated and designed for full light output unless dimmer or bi-level control is indicated:
...
7. Sound Rating: 5. Total harmonic distortion rating of less than 20 percent according to NEMA C82.11.
8. Transient Voltage Protection:
...
13. Lamp Current Crest Factor:
    1. Less than 1.7.
14. Electronic Ballast Operating Frequency:
    1. 20 kHz or higher.
15. Lamp end-of-life detection and shutdown circuit.
16. Transient Protection:
...
21. Automatic lamp starting after lamp replacement.
22. Sound Rating: 4. Total Harmonic Distortion Rating:
    1. Less than 20 percent.
23. Transient Voltage Protection:
...
1.  EG Power Engineering
1.  07/18/17
1.  Lamp Current Crest Factor:
    1.7 or less.
1.  BF:
    1. 0.95 or higher, unless otherwise indicated.
1.  Power Factor:
    1. 0.95 or higher.
1.  Interference: Comply with 47 CFR, Chapter 1, Part 18, Subpart C, for limitations on electromagnetic and radio-frequency interference for nonconsumer equipment.
1.  Ballast Case Temperature: 75 deg C, maximum.
1.  Ballasts for Dimmer-Controlled Lighting Fixtures:
    1. Electronic type.
1.  Dimming Range:
    1. 100 to 10 percent of rated lamp lumens.
1.  Ballast Input Watts:
    1. Can be reduced to 20 percent of normal.
1.  Compatibility:
...
1.  Each luminaire shall be rated for a minimum operational life of 50,000 hours at an average operating time of 12.0 hours per day. This life rating must be conducted 40C ambient temperature.
1.  The rated operating temperature range shall be -30°C to +40°C.
1.  Each luminaire is capable of operating above 100°F [37°C], but not expected to comply with photometric requirements at elevated temperatures.
1.  Photometry must be compliant with IESNA LM-79 and shall be conducted at 25°C
    1.  ambient temperature.
1.  The individual LEDs shall be constructed such that a catastrophic loss or the failure of one LED will not result in the loss of the entire luminaire.
1.  Luminare shall be constructed such that LED modules may be replaced or repaired without replacement of whole luminaire.
1.  Each luminaire shall be listed with Underwriters Laboratory, Inc. under UL1598 for luminaires, or an equivalent standard from a nationally recognized testing laboratory.
...
1.  Each Luminaire shall have integral UL Listed Class II power supplies. Class I power supplies will not be acceptable.
...
1.  Optical Assemblies: LEDs shall be provided with discreet over optical elements to provide proper distributions. All LEDs shall provide the same optical pattern such that catastrophic failures of individual LEDs will not constitute a loss in the distribution pattern.
1.  Illuminance: The illuminance shall not decrease by more than 30% over the expected operating life. The measurements shall be calibrated to standard photopic calibrations.
1.  Light Color/Quality: The luminaire shall have a correlated color temperature (CCT) range of 4,000K to 4,500K. The color rendition index (CRI) shall be 80 or greater. Binning of LEDs shall conform to ANSI/ G. NEMA SSL 3-2010.
...
1.  The LED manufacturer’s maximum thermal pad temperature for the expected life shall not be exceeded.
1.  Thermal management shall be passive by design. The use of fans or other mechanical devices shall not be allowed.
1.  The luminaire shall have a minimum heat sink surface such that LED manufacturer’s maximum junction temperature is not exceeded at maximum rated ambient temperature.
...
1.  The electronics/power supply enclosure shall meet the requirements for NEMA/UL wet location.
1.  Door shall be hinged and secured to the housing in a manner to prevent its accidental opening.
1.  The circuit board and power supply shall be contained inside the luminaire. Electrolytic capacitors used in the power supplies shall be rated for -40°F to 220°F (-40°C to

+105°C), long life ( &gt; 5000 hours ), and operated at no more than 70% of their rated voltage, and 70% of rated current. 06. HIGH-INTENSITY DISCHARGE LAMP BALLASTS 1. General: 1. Comply with NEMA C82.4 and UL 1029. Shall include the following features, unless otherwise indicated.
...
1.  Normal Ambient Operating Temperature:
    1. 110 deg F40 deg C.
1.  Open-circuit operation that will not reduce average life.
...
1. INSTALLATION
1. Fixtures: 1. Set level, plumb, and square with ceilings and walls. Install lamps in each fixture. B. Support for Fixtures in or on Grid-Type Suspended Ceilings: 1. Use grid for support.
