...
3. Record Drawings: 1. The contractor shall coordinate and provide record drawings to the Owner within seven days after substantial completion unless otherwise authorized by the Owner.
   1. INFORMATION FOR THE ENGINEER'S REVIEW AND APPROVAL
...
2. Information for Owner's Review and Approval
   ...
   1. Upon acceptance, the Owner will distribute marked copies via construction bulletins as follows:
      1. One (1) copy - Owner
3. One (1) copy - Owner's Representative
4. Three (3) copies - Contractor
...
1.  The undersigned will reimburse Owner for review or redesign services associated with re-approval by authorities.
1.  The undersigned will coordinate installation and make changes to other Work, which may be required for the Work to be complete with no additional cost to Owner.
1.  The proposed substitution will have no adverse affect on other trades, the construction schedule, or specified warranty requirements.
1.  Maintenance and service parts will be locally available for the proposed substitution.
1.  Attached data includes support items listed in Section 013300, and applicable portions of the data are clearly identified.
1.  Attached data also includes a description of any revisions to the Contract Documents, which the proposed substitution will require for its proper installation.
...
1.  Date
1.  Telephone
1.  List of Attachments: 1. For Use by the  
    Design Consultant
