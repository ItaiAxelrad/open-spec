...
1. Preparation
   ...
   1. Scarify and re-compact top 6 IN of fills and embankments which will be under concrete curb and gutters.
   1. Remove soft or spongy areas.
      1. Replace with aggregate material.
   1. Compact to the following densities:
      1. Cohesive soils: 95% per ASTM D698.
      2. Non-cohesive soils: 75% relative per ASTM D4253 and ASTM D4254.
   1. Assure moisture content is within limits prescribed to achieve required compaction density.
   1. Following compaction, trim and roll to exact cross section.
   1. Check with approved grading template.
   1. Perform density tests on subgrade to determine that subgrade complies with the specification.
2. Aggregate Course:
...
9. Place Concrete:
   1. Comply with Specification Section 03 31 00.
10. Cold and Hot Weather Concreting:
    1. Cold weather:
...
15. Clean Up:
    ...
    3. Quality Control
16. Provide test cylinders for concrete placed.
