...
1. Transient voltage suppression panelboards.
1. DEFINITIONS
1. EMI:
...
1. Time-current curves, including selectable ranges for each type of overcurrent protective device.
1. QUALITY ASSURANCE
...
1. Altitude not exceeding 6800 feet.
1. COORDINATION
...
1. Main and Neutral Lugs:
   1. Mechanical type.
1. Ground Lugs and Bus Configured Terminators:
   1. Compression type.
1. Feed-Through Lugs:
...
1. For Circuit-Breaker Frame Sizes Larger Than 125 A:
...
1. Electronic trip circuit breakers with rms sensing; field-replaceable rating plug or field- replicable electronic trip; and the following field-adjustable settings (for circuit breaker frame sizes 400A and larger):
...
1. Fuses for control-power transformers.
1. Bimetallic-element overload relay.
1. Indicating lights.
1. Seal-in contact.
1. Push buttons.
1. Selector switches.
...
1. Correct malfunctioning units on-site, where possible, and retest to demonstrate compliance; otherwise, replace with new units and retest.
   1. Load Balancing: 1. After Substantial Completion, but not more than 60 days after Final
