...
2.  MANUFACTURERS
    1. The equipment under this Section and the equipment under Section 446200 – Verticel Equipment shall be supplied by the same manufacturer as a complete system to satisfy the Process Performance Warranty described in paragraph 1.2.D of Section 446200. Subject to compliance with requirements, manufacturers offering products that may be incorporated into the Work include the following:
       ...
       2. Approved equal
3.  EQUIPMENT
    1. General 2. Furnish and deliver suction type sludge collectors for installation in three (3) new concrete settling tanks. 3. Tank diameter to be 130 feet. 4. Tank side water depth at maximum water elevation to be 16 feet. 5. Floor slope to be 1/16-inch per foot. 6. Sludge Collector Mechanism 7. Provide a center pier supported, siphon feed design with peripheral overflow. 8. Provide a center drive mechanism that supports and rotates a structural steel cage to which attached are two (2) truss arms and a Unitube sludge collection header and manifold. 9. The header shall be parallel to the tank floor and have a series of inlet orifices such that the entire tank bottom is swept clean in a single revolution. 10. The header shall be designed to uniformly remove sludge in proportion to the area swept with the removal of a larger volume of sludge at greater distances from the tank center. 11. Sludge shall be transported through the header to the center manifold, with removal being accomplished by pumping. 12. Fabricated steel structures shall be shipped in the largest sub-assemblies permitted by carrier regulations, properly matchmarked and identified for ease of field erection.
    1. Design Criteria
...
8.
9.
10. 1. Return Flow (MGD)
11.
12.
13.
14. 1. Mixed Liquor Flow (MGD)
15.
16.
17.
18.     1. Maximum headloss for header 1.30 ft. 4.0MGD peak return flow
    ...
    3. General
       ...
       7. Primary Reduction Unit
       8. Provide commercially available helical gear reducer or gearmotor in a cast housing.
       9. All bearings shall be anti-friction type running in oil.
       10. Motor shall be totally enclosed, ball bearing type, of ample power for starting and continuously operating the drive mechanism without overloading.
       11. Motor to conform to NEMA standards and be suitable for operation on 230/460 volt, 3 phase, 60 Hertz current.
       12. Primary reduction unit shall drive the intermediate reduction through a chain and sprocket arrangement with #80L self-lubricating chain and non-corrosive OSHA approved removable chain guard.
       13. Provide proper chain tension by an adjustable steel base mounted on the intermediate reduction unit.
       14. Intermediate Reduction Unit
       15. Provide worm gear speed reduction with grease and oil lubricated anti-friction type bearings in cast iron housing securely bolted on the machined top face of the final reduction unit. Worm and shaft shall be a two-piece assembly for ease of maintenance. Cycloidal and planetary gearing will not be acceptable.
       16. Align and maintain accurate centers with the final reduction gearing. Swivel base mounting of the intermediate unit will not be acceptable.
       17. Mount an electro-mechanical overload device on the thrust end of the worm shaft consisting of plate spring assembly, plunger, indicator dial two (2) microswitches (one N.O. and one N.C.) and a terminal block, all enclosed in a weather tight, gray cast iron housing. Amperage metering devices will not be considered equal to the overload device specified.
       18. Microswitches shall be factory set to: (1) sound an alarm when the load on the mechanism reaches 100% of the AGMA torque; and (2) stop the motor when the load reaches 120% of the AGMA torque.
       19. Provide a shear pin device, set for 130% of the AGMA torque mounted on the drive end of the worm shaft.
       20. Final Reduction
       21. Provide internal, full depth involute tooth design, ductile iron spur gear driven by a heat-treated steel pinion from the slow speed shaft of the intermediate reduction unit. Stub tooth design will not be acceptable.
       22. Provide bearings at top and bottom of pinion to ensure complete tooth contact between mating surfaces. Pinion and pinion shaft shall be furnished as a two-piece assembly for ease of maintenance.
       23. Provide cast iron turntable base with annular raceway to contain balls upon which the internal gear rotates. The ball race shall ensure low unit ball load, long life and stability without the use of submerged guide shoes, bumpers or steady bearings.
       24. Provide four (4) 3/8-inch thick x 3/4-inch wide renewable special hardened (38-42 Rockwell C) steel liner strips force fitted (pins and cap screws not permitted) into the turntable base and internal gear for balls to bear on vertically and horizontally.
       25. Provide an internal gear of split design with precision mating surfaces for ease of removal of gear, balls and liner strips without raising bridge.
       26. Internal gear, pinion and balls to run in an oil bath and be protected by a felt seal and vertical steel dust shield.
       27. Provide oil filling and level pipe along with a drain plug and sight gauge.
       28. Turntable base shall be bolted to the center column and be designed to support the bridge, internal gear and rotating mechanism.
    4. Flocculation Baffles
    ...
    8. Center Cage, Truss Arm and Manifold
    ...
    11. Effluent Weirs, Scum Baffles, and Density Current Baffles (Supplied by Others): see Specification Section 446470.
    12. Anchor Bolts
    ...
    13. Control Panel
        ...
        3. A “Hand-Off-Auto” switch for the clarifier drive motor
        4. Run indicating light
        5. Fault indicating light with integral reset pushbutton
        6. Clarifier drive motor torque warning indicator light
        7. Clarifier drive motor torque fault indicator light
        8. The clarifier drive motor torque fault switch shall have a latching relay. The drive motor can only be restarted after an over torque shutdown by manual reset.
        9. Controls shall be capable of local (manual) operation or remote operation through the VCR PLC.
        10. Controls shall provide status outputs for: torque warning, torque fault, and Auto / Manual (Hand) condition.
        11. Modes of Operation
        12. In “Auto” the clarifier drive motor will be started and stopped by commands from the VCR PLC.
        13. In “Off ” the clarifier drive motor will stop and remain stopped regardless of any remote signal input.
        14. In “Hand” the clarifier drive motor will run and continue to run regardless of any remote signal input except that over torque protection will function with the unit in “Hand”.
        15. An over torque condition will stop the clarifier drive motor and produce an alarm.
...
4. EQUIPMENT MANUFACTURER'S SERVICES
   ...
   2. Provide for installation assistance as required for the equipment supplied.
   3. Operating Instructions and/or Operator Training
   4. Provide for one (1) four (4) hour working period total to instruct plant Operators for the equipment supplied. The training period will be integrated by the Owner with overall training.
   5. An additional one (1) trip not less than one-half day shall be provided for operation assistance of the equipment supplied.
