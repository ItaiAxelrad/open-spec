...
38. 1. 15
39. 1. 18
40. 1. Hydrostatic pressure testing methodology: 1. General: 1. All joints, including welds, are to be left exposed for examination during the test. 2. Provide additional temporary supports for piping systems designed for vapor or gas to support the weight of the test water. 3. Provide temporary restraints for expansion joints for additional pressure load under test. 4. Isolate equipment in piping system with rated pressure lower than pipe test pressure. 5. Do not paint or insulate exposed piping until successful performance of pressure test. 2. Soil, waste, drain and vent systems: 1. Test at completion of installation of each stack or section of piping by filling system with water and checking joints and fittings for leaks.
    ...
    3. Air testing methodology: 1. General: 1. Assure air is ambient temperature.
    4. Dielectric Testing Methods and Criteria:
