...
1. Date *(not earlier than the Effective Date of the Agreement of the Construction Contract)*:
   ...
   5. Surety and Contractor, intending to be legally bound hereby, subject to the terms set forth below, do each cause this Payment Bond to be duly executed by an authorized officer, agent, or representative.
