...
1. The Owner has established that this Project shall generate the least amount of waste possible.
   ...
   6. Mishandling
   7. Contamination
   8. Damage from weather
   9. Of the inevitable waste that is generated, as many of the waste materials as economically feasible shall be reused, salvaged, or recycled.
   10. Waste disposal in landfills shall be minimized to the greatest extent possible.
   11. WASTE DIVERSION GOALS:
      1. Diversion Goals:
   ...
   12. Clean dimensional wood, pallet wood
   13. Plywood, OSB, and particleboard
   14. Concrete
   15. Bricks
   16. Concrete Masonry Units (CMUs)
   17. Asphalt roofing shingles
   18. Cardboard, paper, packaging
   19. Asphalt roofing shingles
   20. Metals
   21. Gypsum drywall (unpainted)
   22. Paint
   23. Glass
   24. Plastics
   25. Carpet and pad
   26. Beverage containers
   27. DESCRIPTION
   28. WORK INCLUDED:
      2. Waste Management Plan development and implementation.
   29. Meetings:
      3. goals, issues and training for the Waste Management Plan.
   30. Techniques to minimize waste generation.
   31. Sorting and separation of waste materials.
   32. Recycling:
      4. recycling of materials which cannot be reused or sold.
   33. Records keeping:
      5. keeping of receipts and records of salvaged, recycled or landfilled materials.
   34. RELATED SECTIONS:
      6. Division 2 Section – Selective Structure Demolition.
   35. REFERENCES, RESOURCES
   36. GUIDES:
      7. The following publications list agencies and businesses in the reuse, recycling and salvage business community.
   37. Business Reuse and Recycling Catalog:
      8. Available from Calmax:
      9. California Materials Exchange of the California Integrated Waste Management Board (916-255-2369).
   38. Waste Spec:
      10. Model Specifications for Construction Waste Reduction, Reuse, and Recycling. Available from the Triangle J Council of Governments (919-549-0551).
1. SUBMITTALS
   1. WASTE MANAGEMENT PLAN:
      ...
      2. Analysis of the estimated job site waste to be generated, including types and quantities. Use estimate sheets provided.
   2. Proposed Alternatives to Landfilling:
   ...
   10. Separation facilities:
      2. The Contractor shall lay out and label a specific area to facilitate separation of material for reuse, salvage, recycling, and return. Recycling and waste bin areas are to be kept near and clean and clearly marked in order to avoid contamination or mixing materials.
   11. Hazardous wastes:
      3. Hazardous wastes shall be separated, stored, and disposed of according to local, state and federal regulations.
   12. PROGRESS REPORTS
   13. The Contractor shall submit (monthly, quarterly, at end of job), a Waste Management Progress Report. (see form provided) The report shall contain the following information:
      4. The amount (in tons or cubic yards) of material landfilled from the Project, and the identity of the landfill. Include legible copies of manifests, weight tickets, and receipts. Manifests shall be from recycles and/or disposal site operators that can legally accept the materials for the purpose of reuse, recycling or disposal.
   14. For each material recycled, reused, or salvaged from the Project, provide the following:
      5. Amount (in tons or cubic yards)
   15. Date removed from the job site
   16. Receiving party
   17. Indicate the project information, including project title, name of company completing form, beginning and ending dates of period covered by summary form.
