...
4. Definitions
   ...
   7. SHORT INTERVAL SCHEDULE: 1. Schedule prepared by the Contractor reflecting the work planned for the coming weeks. 2. This is also known as a Look-Ahead Schedule.
   8. RESOURCES:
...
2. Baseline Schedule and Narrative Report
   ...
   2. Submittal package:
      1. CPM time-scaled network diagram:
         ...
         1. Activity duration.
         1. Early start and early finish for each activity.
         1. Late start and late finish for each activity.
         1. Total float (TF) for each activity.
         1. Predecessor activities.
         1. Successor activities.
         1. Cost/budget to complete the work in the activity.
         1. Resources needed to complete the activity.
         1. Bar showing the early start and completion dates of each activity.
         1. The Baseline Schedule must include broad-based activities for start-up, operator training, and final completion.
         1. The activities will be sorted by area, trades, and subcontractors as agreed on with the Engineer.
         1. Print the CPM time-scaled network diagram on minimum sheet size of 11 IN x 17 IN.
      2. Narrative report:
         ...
         1. Assumptions used to develop the schedule.
         1. Constraints included in the schedule as defined by the Contract Documents.
         1. The critical path and near critical path activities with an explanation of why those activities are included on those paths.
         1. Number of planned working days per week including shifts per day.
         1. Manpower plan including craft on site per day.
         1. Production rates assumptions.
         1. Major equipment planned for the project and durations for their use.
         1. Resource constraints.
         1. Identification of unusual conditions or restrictions regarding labor, equipment or material.
         1. Calendar(s) used in the contract and how the multiple calendars are used.
         1. Holidays observed during construction.
...
6. CPM General Requirements
   ...
   1. Do not utilize any float suppression techniques or other software features that effect the pure mathematical model calculating the critical path.
...
1. Construction Schedule Meetings
   ...
   1. The Contractor’s Project Manager, Superintendent(s), Scheduler and other key personnel shall attend the pre-construction scheduling meeting.
   1. The pre-construction scheduling meeting will review the requirements of this Specification Section and other specified scheduling and sequencing requirements defined in the Contract Documents.
