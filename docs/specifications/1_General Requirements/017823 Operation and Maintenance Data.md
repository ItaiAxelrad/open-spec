...
1. Summary
   ...
   1. Content requirements for Operation and Maintenance Manuals.
2. Definitions
...
3. Building Materials and Finishes Operation and Maintenance Manuals:
...
7. Draft Operation and Maintenance Manuals:
...
8. Final Operation and Maintenance Manuals:
...
9. Preparation of Submittals
   ...
   1. Identify each equipment item in a manner consistent with names and identification number used in the Contract Documents, not the manufacturer’s catalog numbers.
   1. Neatly type any data not furnished in printed form.
   1. Operation and Maintenance Manuals are provided for Owner's use, to be reproduced and distributed as training and reference materials within Owner's organization.
   ...
   1. Notify supplier and/or manufacturer of the intended use of Operations and Maintenance Manuals provided under the Contract.
10. Operation and Maintenance Manual Format and Delivery:
    ...
    3. Final paper copy submittals:
       ...
       3. 3-Ring Binder:
          ...
          5. Equipment names and summary of tag(s) covered.
          6. Manufacturer name.
          7. Date (month, year).
          8. Provide plastic sheet lifters prior to first page and following last page.
       4. Drawings:
...
11. Equipment Operation and Maintenance Manual Content:
...
12. Building Materials and Finishes Operation and Maintenance Manual Content:
    1. Provide a cover page as the first page of each manual with the following information:
       1. Manufacturer(s) Name and Contact Information.
       2. Vendor’s Name and Contact Information.
       3. Date (month, year).
...
13. Draft Electronic (PDF) Submittals:
...
14. Final Paper Copy Submittals:
