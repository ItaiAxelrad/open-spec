...
1. SUMMARY
   ...
   1. Any other coating, thinner, accelerator, inhibitor, etc., specified or required as part of a complete System specified in this Specification Section.
   1. Minimum surface preparation requirements.
   1. Quality Assurance
...
5. HPIC products listed under subitem D are manufactured by Tnemec except for System #12 which is manufactured by Rust-oleum.
...
6. Paint Systems:
   1. System #1 - Polyamidoamine Epoxy Primer with Polyamidoamine Epoxy or Waterborne Acrylic Polyurethane Finish Coat(s).
      ...
      2. Finish coat(s):
         ...
         1. F2 = 1 coat, 3 mils, Series L69 Epoxoline (Polyamidoamine Epoxy).
         1. Exterior:
         1. F1 = 1 coat, 3 mils, Series L69 Epoxoline (Polyamidoamine Epoxy).
         1. F2 = 1 coat, 2.5 mils, Series 1080 Endura-Shield. W.B. (Waterborne Acrylic Polyurethane).
   ...
   7. System #7 - Waterborne Modified Polyamine Epoxy Primer with Specialized Acrylate Waterborne Top Coats.
      ...
      2. Finish coat(s):
         ...
         1. F2 = 1 coat, 6.5 to 7.5 mils, Series 158 Bio-Lastic (Specialized Waterborne Acrylate).
   8. System #8 - Polyamidoamine Epoxy Primer with Polyamidoamine Epoxy Top Coat.
      ...
      2. Finish coat:
         1. Interior:
         1. F1 = 1 coat, 6 mils, Series L69 Epoxoline (Polyamidoamine Epoxy).
         1. F2 = 1 coat, 6 mils, Series L69 Epoxoline (Polyamidoamine Epoxy).
...
3. Interior Finished Areas:
   1. Refer to Architectural Drawings.
      ...
      2. Appurtenant surfaces include:
         ...
         5. Steel components shall be completely painted (with both prime and finish coats) prior to installing in the wall.
         6. Structural steel.
         7. May include: Pipe supports, duct supports, as well as other structural steel items.
         8. Field welded connections of factory painted structural steel.
         9. Galvanized metal surfaces specifically noted to be painted.
         10. Copper and brass surfaces.
         11. Hollow metal doors and frames.
4. Items Not to Be Painted
   1. General:
   1. Do not paint items listed in this Article unless specifically noted in the Contract Documents to be painted.
5. Items with Approved Factory Finish:
...
8. Schedule of Items to Be Painted and Painting Systems
   1. Item
   1. Description
   1. System
   1. Concrete
...
9. Preparation
   ...
   1. Verify that atmosphere in area where painting is to take place is within paint manufacturer's acceptable temperature, humidity and sun exposure limits.
      1. Provide temporary heating, shade and/or dehumidification as required to bring area within acceptable limits.
         ...
         3. Vent exhaust gases to exterior environment.
         4. No exhaust gases shall be allowed to vent into the space being painted or any adjacent space.
   ...
   1. Remove all dust, grease, oil, compounds, dirt and other foreign matter which would prevent bonding of coating to surface.
   1. Adhere to manufacturer's recoat time surface preparation requirements.
...
11. Prepare and paint before assembly all surfaces which are inaccessible after assembly.
12. Ferrous Metal:
...
14. Galvanized Steel and Non-ferrous Metals:
...
18. Preparation by Abrasive Blasting:
...
19. All Plastic Surfaces and Non-Ferrous Surfaces except Galvanized Steel:
    1. Sand using 80-100 grit sandpaper to scarify surfaces.
20. Contractor shall obtain samples of existing paint film, which is to be removed by abrasive blasting, and have samples tested by a recognized testing laboratory to determine if existing paint film contains lead, asbestos or any other health hazard as defined by the EPA.
...
21. Application
    ...
    1. Immediately after surface has been inspected, apply structural steel and miscellaneous steel prime coat in the factory.
    ...
    1. Provide complete coverage to mil thickness specified.
    ...
    1. If so directed by Engineer, do not apply consecutive coats until Engineer has had an opportunity to observe and approve previous coats.
    1. Apply materials under adequate illumination.
    1. Evenly spread to provide full, smooth coverage.
    1. Work each application of material into corners, crevices, joints, and other difficult to work areas.
    1. Avoid degradation and contamination of blasted surfaces and avoid intercoat contamination.
       1. Clean contaminated surfaces before applying next coat.
    1. Smooth out runs or sags immediately, or remove and recoat entire surface.
    1. Allow preceding coats to dry before recoating.
    ...
    1. Allow coated surfaces to cure prior to allowing traffic or other work to proceed.
    1. Coat all aluminum in contact with dissimilar materials.
    1. When coating rough surfaces which cannot be backrolled sufficiently, hand brush coating to work into all recesses.
    1. Backroll concrete and masonry and gypsum board surfaces with a roller if paint coatings are spray applied.
22. Prime Coat Application:
...
23. Finish Coat Application:
    ...
    3. Color Coding
24. See Specification Section 10 14 00 for color coding.
    1. Field Quality Control
25. Contractor to provide protection for surfaces painted with epoxy coatings to prevent chalking.
    1. Surfaces showing chalking will not be accepted regardless of condition of paint film.
26. Contractor to make provisions to maintain work area within manufacturer's recommended application parameters including temporary heating, ventilation, cooling, dehumidification and provisions utilized to mitigate wind-blown dust and debris from contaminating the wet paint film.
27. All paint and protective coatings shall be applied within the manufacturer’s acceptable environmental and application conditions.
    1. Cleaning
28. Clean paint spattered surfaces.
    1. Use care not to damage finished surfaces.
29. Upon completion of painting, replace hardware, accessories, plates, fixtures, and similar items.
30. Remove surplus materials, scaffolding, and debris.
