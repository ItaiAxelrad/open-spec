...
3. Depth:
   ...
   2. Grid Suspension System for Ceilings:
...
8.  Fire rated Walls:
   ...
   2. Flat Strap and Backing Plate:
      1. Steel sheet for blocking and bracing in length and width indicated.
9.  Minimum Base-Metal Thickness:
      1. 0.0312 inch.
   3. Cold-Rolled Channel Bridging:
...
11. Clip Angle:
      ...
      2. ASTM C 645.
12. Minimum Base Metal Thickness:
...
14. AUXILIARY MATERIALS
   ...
   6. Isolation Strip at Exterior Walls:
...
1. INSTALLATION
   ...
   11. Seismic Bracing:
      2. Sway-brace suspension systems with hangers used for support.
   12. Grid Suspension Systems:
      3. Attach perimeter wall track or angle where grid suspension systems meet vertical surfaces. Mechanically join main beam and cross-furring members to each other and butt-cut to fit into wall track.
   13. Installation Tolerances:
      4. Install suspension systems that are level to within 1/8 inch in 12 feet measured lengthwise on each member that will receive finishes and transversely between parallel members that will receive finishes.
2. INSTALLING FRAMED ASSEMBLIES
   ...
   4.  Door Openings:
      2. Screw vertical studs at jambs to jamb anchor clips on door frames;
   5. install runner track section (for cripple studs) at head and secure to jamb studs.
   ...
   6.  Other Framed Openings:
      4. Frame openings other than door openings the same as required for door openings, unless otherwise indicated. Install framing below sills of openings to match framing required above door heads.
   7.  Fire-Resistance-Rated Partitions:
      5. Install framing to comply with fire-resistance-rated assembly indicated and support closures and to make partitions continuous from floor to underside of solid structure.
      6. Firestop Track:
