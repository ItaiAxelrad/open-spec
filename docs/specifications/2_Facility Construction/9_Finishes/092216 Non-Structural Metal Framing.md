...
tags:
  ['Facility', 'Construction', 'Finishes', 'Non-Structural', 'Metal', 'Framing']
---
...
2. SUSPENSION SYSTEM COMPONENTS
   ...
   2. Wire Hangers:
      ...
      2. Steel sheet, 1 by 3/16 inch.
   3. Carrying Channels:
      1. Cold-rolled, commercial-steel sheet with a base-metal thickness of [] inch and minimum 1/2-inch-wide flanges.
3. Depth:
   1. 2-1/2 inches.
...
4. Products:
   ...
   2. Armstrong World Industries, Inc.; Drywall Grid Systems.
   3. Chicago Metallic Corporation; 640-C Drywall Furring System. c. USG Corporation; Drywall Suspension System.
   4. Approved Equal.
5. STEEL FRAMING FOR FRAMED ASSEMBLIES A. Steel Studs and Runners:
   1. ASTM C 645.
6. Minimum Base-Metal Thickness:
   1. As indicated on Drawings. B. Slip-Type Head Joints:
   2. Where indicated, provide the following:
      1. Single Long-Leg Runner System:
   3. ASTM C 645 top runner with 2-inch- deep flanges in thickness not less than indicated for studs, installed with studs friction fit into top runner and with continuous bridging located within 12 inches of the top of studs to provide lateral bracing.
7. Double-Runner System:
...
9. Flat Strap and Backing Plate:
   1. Steel sheet for blocking and bracing in length and width indicated.
10. Minimum Base-Metal Thickness:
    1. 0.0312 inch.
11. Cold-Rolled Channel Bridging:
...
13. Clip Angle:
    ...
    2. ASTM C 645.
14. Minimum Base Metal Thickness:
...
17. AUXILIARY MATERIALS
18. Fasteners for Metal Framing:
...
19. Isolation Strip at Exterior Walls:
    1. Provide one of the following:
    2. Asphalt-Saturated Organic Felt:
...
1. INSTALLATION
   ...
   4. Isolate suspension systems from building structure where they abut or are penetrated by building structure to prevent transfer of loading imposed by structural movement.
   ...
   6. Where width of ducts and other construction within ceiling plenum produces hanger spacings that interfere with locations of hangers required to support standard suspension system members, install supplemental suspension members and hangers in the form of trapezes or equivalent devices.
   ...
   7. Do not attach hangers to steel roof deck.
   8. Do not attach hangers to permanent metal forms. Furnish cast-in-place hanger inserts that extend through forms.
   9. Do not attach hangers to rolled-in hanger tabs of composite steel floor deck.
   10. Do not connect or suspend steel framing from ducts, pipes, or conduit. C. Fire-Resistance-Rated Assemblies:
   11. Wire tie furring channels to supports.
   12. Seismic Bracing:
   13. Sway-brace suspension systems with hangers used for support.
   14. Grid Suspension Systems:
   15. Attach perimeter wall track or angle where grid suspension systems meet vertical surfaces. Mechanically join main beam and cross-furring members to each other and butt-cut to fit into wall track.
   16. Installation Tolerances:
   17. Install suspension systems that are level to within 1/8 inch in 12 feet measured lengthwise on each member that will receive finishes and transversely between parallel members that will receive finishes.
2. INSTALLING FRAMED ASSEMBLIES
   ...
   3. Slip-Type Head Joints:
   4. Where framing extends to overhead structural supports, install to produce joints at tops of framing systems that prevent axial loading of finished assemblies.
   5. Door Openings:
   6. Screw vertical studs at jambs to jamb anchor clips on door frames;
   7. install runner track section (for cripple studs) at head and secure to jamb studs.
   ...
   8. Other Framed Openings:
   9. Frame openings other than door openings the same as required for door openings, unless otherwise indicated. Install framing below sills of openings to match framing required above door heads.
   10. Fire-Resistance-Rated Partitions:
   11. Install framing to comply with fire-resistance-rated assembly indicated and support closures and to make partitions continuous from floor to underside of solid structure.
   12. Firestop Track:
   ...
   14. Installation Tolerance:
       1. Install each framing member so fastening surfaces vary not more than 1/8 inch from the plane formed by faces of adjacent framing.
