...
2. Related Specification Sections include:
   ...
   6. Quality Assurance
3. Work shall be per: 7. American Concrete Institute (ACI): 1. CT-13, Cement and Concrete Terminology. 2. 304R, Guide for Measuring, Mixing, Transporting and Placing Concrete. 3. 304.2R, Placing Concrete by Pumping Methods. 4. 305.1, Specification for Hot Weather Concreting. 5. 306.1, Standard Specification for Cold Weather Concreting. 6. 308.1, Specification for Curing Concrete. 7. 309R, Guide for Consolidation of Concrete. 8. ASTM International (ASTM): 1. C94/C94M, Standard Specification for Ready-Mixed Concrete. 2. C156, Standard Test Method for Water Loss (from a Mortar Specimen) Through Liquid Membrane-Forming Curing Compounds for Concrete. 3. C171, Standard Specification for Sheet Materials for Curing Concrete. 4. C309, Standard Specification for Liquid Membrane-Forming Compounds for Curing Concrete. 5. D994, Standard Specification for Preformed Expansion Joint Filler for Concrete (Bituminous Type). 6. D1056, Standard Specification for Flexible Cellular Materials-Sponge or Expanded Rubber. 7. D1751, Standard Specification for Preformed Expansion Joint Filler for Concrete Paving and Structural Construction (Nonextruding and Resilient Bituminous Types). 9. Corps of Engineers (COE): 1. CRD-C572, Specifications for Polyvinylchloride Waterstop. 10. National Ready Mixed Concrete Association (NRMCA): 1. Checklist for Certification of Ready Mixed Concrete Production Facilities. 11. NSF International (NSF).
4. Qualifications: 12. Ready mixed concrete batch plant shall be certified by NRMCA. 13. Waterstop manufacturer’s representative shall provide on-site training of waterstop installation, field splicing, welding and inspection procedures prior to construction, and at no additional cost. If waterstop installers have prior training, provide proof of training. 14. Submittals
5. Shop Drawings shall include: 15. Product technical data including: 1. Acknowledgement that products submitted meet requirements of the aforementioned standards. 2. Manufacturer’s installation instructions include procedure for adding high-range water reducer at the jobsite. 3. Scaled drawings showing proposed locations and types of construction joints. 4. Manufacturers and types of the following: 1. Joint fillers. 2. Curing agents. 3. Construction joint bonding adhesive. 4. Waterstops. 16. Certifications of the following: 1. Ready mix concrete plant certification. 2. Waterstops: 1. Products shipped meet or exceed the physical properties specified. 2. Certificate of training from the waterstop manufacturer for the individuals performing field welds of waterstops.
6. Information submittals: 17. Copies of concrete delivery tickets. 18. Description of proposed curing methods. 19. Delivery, Storage, and Handling
7. Delivery: 20. Concrete: 1. Prepare a delivery ticket for each load of ready mixed concrete. 2. Truck operator shall hand ticket to Contractor at the time of delivery. 3. Ticket to show: 1. Mix identification. 2. Quantity delivered. 3. Amount of material in each batch. 4. Outdoor temperature in the shade. 5. Time at which cement was added 6. Time of delivery. 7. Time of discharge. 8. Amount of water that may be added at the site without exceeding the specified water-cement ratio. 9. Amount of water added at the site. 21. Project Conditions
8. Adjust concrete mix design when material characteristics, job conditions, weather, strength test results or other circumstances warrant. 22. Revised concrete mix design must be approved by the Engineer.
...
1. Preparation
   ...
   1. Remove earth, snow, ice, water, and other foreign materials from areas that will receive concrete.
   1. Secure reinforcement in place.
   1. Position expansion joint material, anchors and other embedded items.
   1. Obtain approval of reinforcement erection and placement prior to placing concrete.
   1. Do not place concrete during rain, sleet, or snow, unless adequate protection is provided and approval is obtained.
   ...
   1. Remove hardened concrete and foreign materials from inner surfaces of conveying equipment and formwork.
   1. Provide slabs and beams of minimum indicated required depth when sloping structural foundation base slabs and elevated slabs to drains.
...
4. Concrete Mixing
   ...
   1. Batch, mix, and transport in accordance with ASTM C94/C94M.
...
6. Tempering and Control of Mixing Water:
...
7. Placing of Concrete
   ...
   1. Do not begin placing concrete during rain, sleet, or show.
      1. Protect fresh concrete from ensuing inclement weather.
   1. Do not deposit concrete which has partially hardened or has been contaminated by foreign materials.
   1. Begin work only when work of other trades affecting concrete is complete.
   1. Deposit concrete:
      1. Continuously to avoid cold joints.
   1. Locate construction joints at locations approved by Engineer.
   ...
   1. Deposit concrete as nearly as practicable in its final position to avoid segregation.
   ...
   1. Perform the following operations before bleeding water has an opportunity to collect on surface:
      1. Spread.
      2. Consolidate.
      3. Straightedge.
      4. Darby or bull float.
   1. No water shall be added to the concrete surface to ease finishing operation.
8. Cold Weather Concrete Placement:
...
9. Hot Weather Concrete Placement:
...
11. Handle concrete from mixer to place of final deposit by methods which will prevent segregation or loss of ingredients and in a manner which will assure that required quality of concrete is maintained.
...
12. Construction Joints – General:
...
13. Construction Joints - Spacing Unless Otherwise Specified:
    ...
    2. Water retaining structures:
       ...
       3. Floor slab, construction joints:
          ...
          3. Twice the length of the short side.
          4. 60 FT.
       4. Elevated slab construction joints:
          ...
          3. Twice the length of the short side.
          4. 70 FT.
14. Construction Joints – Bonding:
...
15. Locate control joints in slabs on grade as indicated on Drawings.
...
22. Protect concrete from premature drying, excessively hot or cold temperatures, and mechanical injury immediately after placement, and maintain with minimal moisture loss at relatively constant temperature for period necessary for hydration of cement, hardening, and compressive strength gain.
...
23. Apply one of the following curing procedures immediately after completion of placement and finishing (surfaces not in contact with forms).
...
28. Protection from Mechanical Injury:
