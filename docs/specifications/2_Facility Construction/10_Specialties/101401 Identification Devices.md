...
1. National Electrical Manufacturers Association/American National Standards Institute (NEMA/ANSI):
...
8. Schedules
   ...
   1. Trenches with piping:
      ...
      4. Natural gas or digester gas:
         ...
         2. Legend:
         3. First line: “CAUTION CAUTION CAUTION”
         4. Second line: “BURIED GAS LINE BELOW”
      5. Potable water:
         1. Blue with black letters.
         2. Legend:
         3. First line: “CAUTION CAUTION CAUTION”
         4. Second line: “BURIED WATER LINE BELOW”
      6. Storm and sanitary sewer lines:
         1. Color: Green with black letters.
         2. Legend:
         3. First line: “CAUTION CAUTION CAUTION”
         4. Second line: “BURIED SEWER LINE BELOW”
      7. (Nonpotable) water piping, except 3 IN and smaller irrigation pipe:
         1. Color: Green with black letters.
         2. Legend:
         3. First line: “CAUTION CAUTION CAUTION”
         4. Second line: “BURIED NONPOTABLE WATER LINE BELOW”
      8. Chemical feed piping (e.g., chlorine solution)
         1. Color: Yellow with black letters.
         2. Legend:
         3. First line: “CAUTION CAUTION CAUTION”
         4. Second line: “BURIED CHEMICAL LINE BELOW”
      9. Other piping (e.g., compressed air, irrigation, refrigerant, heating water, etc.):
         1. Color: Yellow with black letters.
         2. Legend:
         3. First line: “CAUTION CAUTION CAUTION”
         4. Second line: “BURIED PIPE LINE BELOW”
   1. Yard valves, buried, with valve box and concrete pad:
   ...
   1. Valves and slide gates:
      1. Tag type:
         1. Outdoor locations: Type B1 - Square Nonmetallic Tags.
         2. Indoor noncorrosive:
         3. Type A1 - Round Metal Tags.
         4. Type B1 - Square Nonmetallic Tags.
         5. Indoor corrosive:
         6. Stainless steel Type A1 - Round Metal Tags.
         7. Type B1 - Square Nonmetallic Tags.
      2. Fastener:
      ...
      3. Legend:
         1. Letter height: 1/4 IN minimum.
         2. Valve designation as indicated on the Drawings (e.g., “V-xxx”).
   1. Process equipment (e.g., pumps, pump motors, blowers, etc.):
      1. Tag type:
   ...
   1. Process tanks (over 1000 GAL) and basins, (e.g., chemical storage):
      1. Tag type:
   ...
   1. Tanks (less than 1000 GAL) (e.g., chemical tanks):
      1. Tag type:
         1. Type D - Self-Adhesive Tape Tags and Signs.
      2. Fastener: Self.
      3. Legend:
         1. Letter height: 2 IN minimum.
   1. Equipment that starts automatically:
      1. Tag type:
         1. Type B2 - Nonmetallic Signs.
...
11. Electrical Systems:
    ...
    2. Switchgear, switchboards and motor control centers:
       ...
       3. Main equipment legend:
          ...
          1. Subsequent lines: 3/8 IN minimum.
          1. First line: Equipment name (e.g., "MAIN SWITCHBOARD MSBxxx").
          1. Second line:
          1. Source of power (e.g., "FED FROM MCCxxx LOCATED IN ROOM xxx").
          1. Include the building name or number if the source is in another building.
          1. Third line: System voltage and phase (e.g., “480/277 V, 3PH”).
    ...
    3. Panelboards and transformers:
       ...
       3. Legend:
          ...
          1. Subsequent lines: 3/16 IN minimum.
          1. First line: Equipment name (e.g., "PANELBOARD LPxxx" or "TRANSFORMER Txxx").
          1. Second line (panelboards only): System voltage and phase (e.g., “208/120V, 3PH”).
          1. Third line:
          1. Source of power (e.g., "FED FROM MCCxxx LOCATED IN ROOM xxx").
          1. Include the building name or number if the source is in another building.
    4. Transfer switches:
       ...
       3. Legend:
          ...
          1. First line: 3/8 IN minimum.
          1. Subsequent lines: 3/16 IN minimum.
          1. First line: Equipment name (e.g., "AUTOMATIC TRANSFER SWITCH ATSxxx").
    ...
    15. Color Coding
12. Color and band piping in accordance with State of State Department of Public Health and Environment, Design Criteria for Potable Water Systems.
    1. Place bands:
...
13. Provide Chemical Hazard and Safety Signs on all chemical tanks and on the exterior of the chemical storage room, pump room, and filter room.
