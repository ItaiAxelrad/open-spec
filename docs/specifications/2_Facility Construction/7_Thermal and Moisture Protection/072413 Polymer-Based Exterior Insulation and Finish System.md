...
2. SUMMARY
   ...
   1. sealants.
3. Division 09 Section "Gypsum Board" for Exterior Gypsum Board and EFS soffit vent.
4. SYSTEM DESCRIPTION
   1. Class PB EFS: 1. A non-load-bearing, exterior wall cladding system that consists of
...
6. Weathertightness: 1. Resistant to water penetration from exterior into EFS and assemblies
   ...
   1. Class PB EFS: 1. Provide EFS having physical properties and structural performance that comply
      with the following: 1. Abrasion Resistance: 1. Sample consisting of 1-inch-thick EFS mounted on 1/2-inch-thick gypsum
...
10. Mildew Resistance of Finish Coat:
...
16. Wind-Driven-Rain Resistance: Resist wind-driven rain according to ICC-ES AC219.
17. Impact Resistance: Sample consisting of 1-inch-thick EFS when constructed,
18. conditioned, and tested per EIMA 101.86; and meeting or exceeding the following:
    1. Standard Impact Resistance:
       1. 25 to 49 inch-lb.
19. Structural Performance Testing: EFS assembly and components shall comply with ICC- ES AC219
20. when tested per ASTM E 330.
21. SUBMITTALS
    1. Product Data:
       1. For each type and component of EFS indicated.
    1. Shop Drawings: 1. For EFS. Include plans, elevations, sections, details of components, details
...
22. Include similar Samples of joint sealants and exposed accessories involving color
    1. selection.
    1. Samples for Verification: 1. 12-inch-square panels for each type of finish-coat color and texture
...
23. Include sealants Samples to verify color selected.
    1. Qualification Data:
       1. For Installer and testing agency.
    1. Material or Product Certificates:
       1. For each joint sealant, from manufacturer.
    1. Compatibility and Adhesion Test Reports: 1. For joint sealants from sealant manufacturer
       indicating the following: 1. Materials forming joint substrates and joint-sealant backings have been tested for
    1. compatibility and adhesion with joint sealants.
24. Interpretation of test results and written recommendations for primers and substrate
    1. preparation needed for adhesion.
    1. Field quality-control reports.
25. QUALITY ASSURANCE
    1. Installer Qualifications: 1. An installer who is certified in writing by EFS manufacturer as
       qualified to install manufacturer's system using trained workers.
    1. Source Limitations: 1. Obtain EFS from single source from single EFS manufacturer and from
       sources approved by EFS manufacturer as compatible with system components.
    1. Fire-Test-Response Characteristics: 1. Provide EFS and system components with the following
...
28. 1. Preinstallation Conference:
...
30. PROJECT CONDITIONS
    1. Weather Limitations: 1. Maintain ambient temperatures above 40 deg F for a minimum of 24 hours
    ...
    1. requirements.
    1. Field Measurements: 1. Verify actual dimensions required for prefabricated panels by field
...
1. MANUFACTURERS
   1. Manufacturers: 1. Subject to compliance with requirements, provide products by one of the
      following: 1. Dryvit Systems, Inc.
2. Omega Products International, Inc.
3. Senergy; Degussa Wall Systems, Inc.
4. Sto Corp.
5. MATERIALS
   1. Compatibility: 1. Provide adhesive, fasteners, reinforcing meshes, base- and
   ...
   1. Exterior Sheathing Board: 1. Comply with requirements in Division 9 Section “Gypsum
      Board.”
   1. Reinforcing Mesh: 1. Balanced, alkali-resistant, open-weave, glass-fiber mesh treated for
   ...
   1. Primer: 1. EFS manufacturer's standard factory-mixed, elastomeric-polymer primer for
      preparing base-coat surface for application of finish coat.
   1. Finish-Coat Materials: 1. EFS manufacturer's standard acrylic-based coating complying with the
      following: 1. Factory-mixed formulation of polymer-emulsion binder, colorfast mineral pigments, sound
   1. stone particles, and fillers.
6. Colors: 1. As selected by Architect from manufacturer's full range.
   1. Water:
      1. Potable.
   1. Trim Accessories: 1. Type as designated or required to suit conditions indicated and to comply
...
8. ELASTOMERIC SEALANTS
   1. Elastomeric Sealant Products: 1. Provide EFS manufacturer's listed and recommended
...
9. MIXING 1. General: 1. Comply with EFS manufacturer's requirements for combining and mixing materials.
...
1. EXTERIOR SHEATHING BOARD INSTALLATION
   1. Exterior Sheathing Board: 1. Install on metal framing to comply with sheathing-board
      manufacturer's written instructions and evaluation report acceptable to authorities having 1. Install board with steel drill screws spaced no more than 8 inches o.c. along
      framing with perimeter fasteners at least 3/8 inch but less than 5/8 inch from edges of boards.
1. EFS INSTALLATION, GENERAL
   ...
   1. Expansion Joints: 1. Install at locations indicated, where required by EFS manufacturer, and as
      follows: 1. At expansion joints in substrates behind EFS.
1. Where EFS adjoin dissimilar substrates, materials, and construction, including other
   1. EFS.
1. Where EFS manufacturer requires joints in long continuous runs.
1. TRIM INSTALLATION
   1. Trim: 1. Apply trim accessories at perimeter of EFS, at expansion joints, and elsewhere as
      indicated, according to EFS manufacturer's written instructions.
1. Expansion Joint:
   1. Use where indicated on Drawings.
1. BASE-COAT INSTALLATION
   1. Base Coat: 1. Apply to exposed surfaces in minimum thickness recommended in writing by
      EFS manufacturer, but not less than 1/16-inch dry-coat thickness.
   1. Reinforcing Mesh: 1. Embed type indicated below in wet base coat to produce wrinkle-free
...
1. Standard-impact reinforcing mesh.
1. FINISH-COAT INSTALLATION
   1. Primer:
      1. Apply over dry base coat according to EFS manufacturer's written instructions.
   1. Finish Coat: 1. Apply over drybase coat, maintaining a wet edge at all times for uniform
...
1. Clean surfaces to receive sealants to comply with indicated requirements and EFS
   1. manufacturer's written instructions.
1. Apply primer recommended in writing by sealant manufacturer for surfaces to be sealed.
1. Install sealant backing to control depth and configuration of sealant joint and to prevent
   1. sealant from adhering to back of joint.
1. Apply masking tape to protect areas adjacent to sealant joints. Remove tape immediately after
   1. tooling joints, without disturbing joint seal.
1. Recess sealant sufficiently from surface of EFS so an additional sealant application,
