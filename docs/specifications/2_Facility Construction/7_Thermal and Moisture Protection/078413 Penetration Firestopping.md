...
2. SUMMARY
   ...
   1. penetrating items.
3. PERFORMANCE REQUIREMENTS 1. General: 1. For penetrations through fire-resistance-rated constructions, including both
...
4. Fire-resistance-rated walls including fire walls, fire partitions, and smoke barriers.
5. Fire-resistance-rated horizontal assemblies including floors, floor/ceiling assemblies, and
   1. ceiling membranes of roof/ceiling assemblies.
   1. Rated Systems: 1. Provide through-penetration firestop systems with the following ratings
      determined per ASTM E 814: 1. F-Rated Systems: 1. Provide through-penetration firestop systems with F-ratings indicated, but
...
8. cfm/sq. ft at both ambient temperatures and 400 deg F.
...
9. For piping penetrations for plumbing and wet-pipe sprinkler systems, provide moisture-
   1. resistant through-penetration firestop systems.
10. For floor penetrations with annular spaces exceeding 4 inches in width and exposed to
...
11. For penetrations involving insulated piping, provide through-penetration firestop systems not
...
12. SUBMITTALS
    ...
    1. Shop Drawings: 1. For each through-penetration firestop system, show each type of
       construction condition penetrated, relationships to adjoining construction, and type of penetrating 1. Include firestop design designation of qualified testing and inspecting agency that evidences
       compliance with requirements for each condition indicated.
13. Submit documentation, including illustrations, from a qualified testing and inspecting agency
    1. that is applicable to each through-penetration firestop system configuration for construction and
    1. penetrating items.
14. Where Project conditions require modification to a qualified testing and inspecting
    ...
    1. Qualification Data:
       1. For Installer.
    1. Product Certificates: 1. For through-penetration firestop system products, signed by product
       manufacturer.
15. QUALITY ASSURANCE
    1. Provide penetration firestopping materials approved by FM Global.
    1. Installation Responsibility: 1. Installation of interior joint sealants, through-penetration
    ...
    1. Source Limitations: 1. Obtain through-penetration firestop systems, for each kind of
       penetration and construction condition indicated, through one source from a single manufacturer.
    1. Fire-Test-Response Characteristics: 1. Provide through-penetration firestop systems that
...
16. Through-penetration firestop systems are identical to those tested per testing standard
    1. referenced in "Part 1 Performance Requirements" Article. Provide rated systems complying
    1. with the following requirements: 1. Through-penetration firestop system products bear classification marking of
       qualified testing and inspecting agency. 1. Through-penetration firestop systems correspond to those indicated by reference to
       through-penetration firestop system designations listed by the following: 1. 1) UL in its "Fire Resistance Directory."
    1. Preinstallation Conference: 1. Conduct conference at Project site to comply with
       requirements in
...
18. PROJECT CONDITIONS
    1. Environmental Limitations: 1. Do not install through-penetration firestop systems when
...
1. MANUFACTURERS
   1. Products: 1. Subject to compliance with requirements, provide one of the through-penetration
...
8. FIRESTOPPING, GENERAL
   1. Compatibility: 1. Provide through-penetration firestop systems that are compatible with one
   ...
   1. Accessories: 1. Provide components for each through-penetration firestop system that are
   ...
   1. are not limited to, the following items: 1. Permanent forming/damming/backing materials, including the following: 1. Slag-/rock-wool-fiber insulation. 1. Sealants used in combination with other forming/damming/backing materials to prevent
      leakage of fill materials in liquid state. 1. Fire-rated form board. d. Fillers for sealants.
9. Temporary forming materials.
10. Substrate primers.
11. Collars.
12. Steel sleeves.
13. FILL MATERIALS
    1. Cast-in-Place Firestop Devices: 1. Factory-assembled devices for use in cast-in-place
    ...
    1. neoprene gasket.
    1. Latex Sealants: 1. Single-component latex formulations that after cure do not re-emulsify
       during exposure to moisture.
    1. Firestop Devices: 1. Factory-assembled collars formed from galvanized steel and lined with
       intumescent material sized to fit specific diameter of penetrant.
    1. Intumescent Composite Sheets: 1. Rigid panels consisting of aluminum-foil-faced elastomeric
       sheet bonded to galvanized steel sheet.
    1. Intumescent Putties: 1. Nonhardening dielectric, water-resistant putties containing no
       solvents, inorganic fibers, or silicone compounds.
    1. Intumescent Wrap Strips: 1. Single-component intumescent elastomeric sheets with aluminum
       foil on one side.
    1. Mortars: 1. Prepackaged dry mixes consisting of a blend of inorganic binders, hydraulic
    ...
    1. Pillows/Bags: 1. Reusable heat-expanding pillows/bags consisting of glass-fiber cloth cases
       filled with a combination of mineral-fiber, water-insoluble expansion agents, and fire-retardant
    1. additives.
    1. Silicone Foams: 1. Multicomponent, silicone-based liquid elastomers that, when mixed,
       expand and cure in place to produce a flexible, nonshrinking foam.
    1. Silicone Sealants: 1. Single-component, silicone-based, neutral-curing elastomeric sealants
       of grade indicated below: 1. Grade: 1. Pourable (self-leveling) formulation for openings in floors and other horizontal
...
1. PREPARATION
   1. Surface Cleaning: 1. Clean out openings immediately before installing
...
1. Clean opening substrates and penetrating items to produce clean, sound surfaces capable of
...
1. Remove laitance and form-release agents from concrete.
   1. Priming: 1. Prime substrates where recommended in writing by through-penetration firestop
   ...
   1. Masking Tape: 1. Use masking tape to prevent through-penetration firestop systems
...
1. THROUGH-PENETRATION FIRESTOP SYSTEM INSTALLATION 1. General: 1. Install through-penetration firestop systems to comply with Part 1
...
1. After installing fill materials and allowing them to fully cure, remove combustible
   ...
   1. Install fill materials for firestop systems by proven techniques to produce the following
      results: 1. Fill voids and cavities formed by openings, forming materials, accessories, and
   1. penetrating items as required to achieve fire-resistance ratings indicated.
1. Apply materials so they contact and adhere to substrates formed by openings and penetrating
   1. items.
1. For fill materials that will remain exposed after completing Work, finish to produce smooth,
...
1. IDENTIFICATION
   ...
   1. systems so that labels will be visible to anyone seeking to remove penetrating items or firestop 1. Use mechanical fasteners for metal labels. For plastic labels, use self-adhering type
...
1. Sub-contractor's name, address, and phone number.
1. Through-penetration firestop system designation of applicable testing and inspecting agency.
1. Date of installation.
1. Through-penetration firestop system manufacturer's name.
1. Installer's name.
1. FIELD QUALITY CONTROL
   1. Inspecting Agency: 1. Contractor shall engage a qualified, independent inspecting agency to
...
1. CLEANING AND PROTECTING
   ...
   1. Provide final protection and maintain conditions during and after installation that ensure
      that through-penetration firestop systems are without damage or deterioration at time of project 1. If, despite such protection, damage or deterioration occurs, cut out and remove
