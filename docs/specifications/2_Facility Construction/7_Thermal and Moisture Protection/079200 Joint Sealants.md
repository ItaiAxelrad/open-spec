...
1. Acceptable Manufacturers
   ...
   1. Silicone sealants:
      ...
      3. Dow Corning.
      4. Tremco.
   1. Open-Cell Polyrethane Foam
      1. Emseal Colorseal
   1. Backer rod, compressible filler, primer, joint cleaners, bond breaker:
...
3. Materials
   ...
   1. Where compound is not exposed to view in finished work, provide manufacturer's color which has best performance.
   1. Non-sagging sealant for vertical and overhead horizontal joints.
   1. Sealants for horizontal joints: Self-leveling pedestrian/traffic grade.
   1. Joint cleaner, primer, bond breaker: As recommended by sealant manufacturer.
   1. Sealant backer rod and/or compressible filler:
   ...
   1. Exterior envelope sealants meet minimum 2015 IECC air leakage requirements.
...
11. Open-Cell Polyurethane Foam
...
6. Clean all joints.
7. Make all joints water and airtight.
8. Make depth of sealing compounds, except expanding foam and polyurea sealant, not more than one-half width of joint, but in no case less than 1/4 IN nor more than 1/2 IN unless recommended otherwise by the manufacturer.
9. Provide correctly sized backer rod, compressible filler or compressible sealant in all joints to depth recommended by manufacturer:
...
10. Apply bond breaker where required.
11. Tool sealants using sufficient pressure to fill all voids.
12. Upon completion, leave sealant with smooth, even, neat finish.
13. Where piping, conduit, ductwork, etc. penetrate wall, seal each side of wall opening.
14. Install compressible sealant to position at indicated depth.
...
15. Install expanding foam sealant to minimum 4 IN depth or thickness of wall being penetrated if less than 4 IN or as indicated on Drawings.
...
16. Install open-cell polyurethane foam to building expansion joints in accordance with manufacturer’s installation instructions.
...
18. Schedule
    ...
    1. Interior areas:
       1. Noncorrosive areas:
          ...
          1. Dry exposure: Polyether, unless noted otherwise.
    ...
    1. Compressible sealant: Where indicated.
    1. Exterior wall penetrations: Expanding urethane foam, with finish sealant.
       1. Finish sealant:
          1. Exterior side:
          1. Above grade: Polyether.
          1. Below grade: Polyurethane.
          1. Interior side:
          1. Noncorrosive area:
       1. Wet exposure:
          1. Polyether.
