...
3. PERFORMANCE REQUIREMENTS
   1. Delegated Design: 1. Design metal wall panel assembly, including comprehensive engineering
      analysis by a qualified professional engineer, using performance requirements and design
   1. criteria indicated.
   1. Structural Performance: 1. Provide metal wall panel assemblies capable of withstanding the
...
5. SUBMITTALS
   ...
   1. Shop Drawings: 1. Show fabrication and installation layouts of metal wall panels; details of
   ...
   1. Delegated-Design Submittal: 1. For metal wall panel assembly indicated to comply
   ...
   1. Coordination Drawings: 1. Exterior elevations drawn to scale and coordinating penetrations
      and wall-mounted items.
   1. Product test reports. G. Maintenance data.
   1. Warranties:
      1. Samples of special warranties.
6. QUALITY ASSURANCE
   1. Installer Qualifications: 1. An employer of workers trained and approved by manufacturer. B.
      Preinstallation Conference: Conduct conference at Project site.
7. Review and finalize construction schedule and verify availability of materials,
   1. Installer's personnel, equipment, and facilities needed to make progress and avoid delays.
8. Review methods and procedures related to metal wall panel installation,
   1. including manufacturer's written instructions.
9. Examine support conditions for compliance with requirements, including alignment
   1. between and attachment to structural members.
10. Review flashings, special siding details, wall penetrations, openings, and condition of
    1. other construction that will affect metal wall panels.
11. Review governing regulations and requirements for insurance, certificates, and tests and
    1. inspections if applicable.
12. Review temporary protection requirements for metal wall panel assembly during and
    1. after installation.
13. Review wall panel observation and repair procedures after metal wall panel installation.
14. WARRANTY
    1. Special Warranty: 1. Manufacturer's standard form in which manufacturer agrees to repair or
...
15. Warranty Period: 1. Two years from date of project completion.
    1. Special Warranty on Panel Finishes: 1. Manufacturer's standard form in which manufacturer
...
16. Finish Warranty Period:
    1. 20 years from date of project completion.

## Products

1. PANEL MATERIALS
   1. Aluminum Sheet: 1. Coil-coated sheet, ASTM B 209, alloy as standard with manufacturer, with
      temper as required to suit forming operations and structural performance required.
1. Surface:
   1. Smooth, flat finish.
1. Exposed Coil-Coated Finish: 1. 3-Coat Fluoropolymer: 1. AAMA 620. Fluoropolymer finish containing not less than 70
...
1. Joint Sealant:
   ...
   1. manufacturer.
1. Butyl-Rubber-Based, Solvent-Release Sealant:
   1. ASTM C 1311.
1. MISCELLANEOUS MATERIALS
   1. Panel Fasteners: 1. Self-tapping screws, bolts, nuts, self-locking rivets and bolts,
...
1. Panel Height:
   1. 1-1/2 inches.
1. ACCESSORIES
   1. Wall Panel Accessories: 1. Provide components required for a complete metal wall
...
1. Closures: 1. Provide closures at eaves and rakes, fabricated of same metal as metal wall
   1. panels.
   1. Flashing and Trim: 1. Formed from 0.018-inch minimum thickness, zinc-coated (galvanized) steel
...
1. FABRICATION 1. General: 1. Fabricate and finish metal wall panels and accessories at the factory to greatest
   ...
   1. Sheet Metal Accessories: 1. Fabricate flashing and trim to comply with recommendations in
...
1. METAL WALL PANEL INSTALLATION
   1. Lap-Seam Metal Wall Panels: 1. Fasten metal wall panels to supports with fasteners at each
...
1. Provide metal-backed washers under heads of exposed fasteners bearing on weather side of
   1. metal wall panels.
1. Locate and space exposed fasteners in uniform vertical and horizontal alignment. Use
...
1. Install screw fasteners with power tools having controlled torque adjusted to compress
   ...
   1. predrilled holes.
1. Provide sealant tape and flashing at lapped joints of metal wall panels and between panels
   1. and protruding equipment, vents, and accessories. Seal all penetrations watertight.
1. Apply a continuous ribbon of sealant tape to weather-side surface of fastenings on end
...
1. At panel splices, nest panels with minimum 6-inch end lap, sealed with butyl-rubber
   1. sealant and fastened together by interlocking clamping plates.
1. ACCESSORY INSTALLATION 1. General: 1. Install accessories with positive anchorage to building and weathertight mounting,
...
1. Install components required for a complete metal wall panel assembly including trim,
   ...
   1. items.
   1. Flashing and Trim: 1. Comply with performance requirements, manufacturer's written
