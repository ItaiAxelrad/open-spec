...
4.  QUALIFICATIONS
   8. Equipment Installer Qualifications:
    ...
    1.  Surface Installer Qualifications:
	2. Company specializing in outdoor resilient surfaces in the USA for at least 10 years. The applicator shall be approved and trained, with a minimum of three years' documented experience. Conditions of all surface substrates with respect to structural performance shall be evaluated and approved by the surface installer prior to application of surface system.
5.  DELIVERY AND STORAGE
   1. Deliver and store products in original, unopened containers with labels intact when not being installed and protect during construction operations to prevent damage, theft, or vandalism.
    1.  Inspect parts within 48 hours of delivery, compare with manufacturers bill of material, and report any missing or non-conforming parts to manufacturer.
    2.  All surface materials shall be protected from weather and binders shall be stored in temperatures no lower than 40° F.
    3.  All touch up, cleaning, repair or replacement shall be at contractor's expense.
6.  WARRANTY
   2. Minimum lifetime warranty on all deck posts, steel deck posts, and fastening system, and associated fastening hardware against structural failure caused by corrosion or deterioration from exposure to weather, or defective materials or defective workmanship.
    1.  Minimum 15-year warranty on support materials and decks against structural failure caused by corrosion, defective materials, or defective workmanship.
    2.  Minimum 10-year warranty on all steel components including railings, loops, and rungs against structural failure caused by defective materials or defective workmanship.
    3.  Minimum 1-year warranty on all products not listed above against structural failure caused by defective materials or defective workmanship.
    4.  Minimum 5-year warranty on safety surfacing against structural failure caused by defective materials or defective workmanship.
7.  MINIMAL WEATHER CONDITIONS
   3. At the time of surface material application, ambient air temperature shall be no less than 40 °F and rising and remain so for at least 72 hours after completion.
    1.  All surface materials shall be protected from weather and other damage prior to application, during application and while curing.
...
2. MATERIALS
   ...
   1. Poured-in-Place Binder:
	2. An elastic polyurethane pre-polymer with minimal odor, excellent weathering and binding characteristics. Binder shall be 100% MDI based and contain 0% TDI monomers.
	3. TDI is listed as a carcinogen with OSHA and the IARC. Special handling is required with more than 0.1% TDI.
   1. Poured-in-Place black base:
	4. Shall be recycled SBR rubber:
   ...
   1.  Poured-in-Place System shall:
	6. Have been tested for shock attenuation under ASTM F 1292 G-Max and HIC.
	7. Be non-slip and porous.
	8. Have Class B fire rating.
	9.  Have the following minimum technical specifications:
...
3. Play Equipment Installation:
	5. Assemble all equipment that requires pre-assembly before installation begins.
	6. Install equipment at the locations agreed upon. Install level, plumb, secure and in accordance with manufacturer's recommendations, directions, and detail drawings. Cooperate with other trades. Repair and replace damaged units as directed by the owner's representative.
	7. Protect installed equipment from damage, blemishes, or indication of use until completion and acceptance of the project.
