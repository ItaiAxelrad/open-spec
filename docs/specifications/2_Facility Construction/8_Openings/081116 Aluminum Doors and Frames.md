...
3. Aluminum frames for aluminum flush panel doors. B. Related Sections:
...
5. Details of doors, including vertical and horizontal edge details and metal thicknesses.
6. Frame details for each frame type, including dimensioned profiles and metal thicknesses.
7. Locations of reinforcement and preparations for hardware.
8. Details of each different wall opening condition.
9. Details of anchorages, joints, field splices, and connections.
10. Details of accessories.
11. Details of moldings, removable stops, and glazing.
12. Details of conduit and preparations for power, signal, and control systems. C. Samples for Initial Selection:
    ...
    1. 3 by 5 inches.
13. For the following items, prepared on Samples about 12 by 12 inches to demonstrate compliance with requirements for quality of materials and construction:
    1. Doors:
...
16. Provide additional protection to prevent damage to finish of factory-finished units.
...
17. Provide minimum 1/4-inch space between each stacked door to permit air circulation.
...
1. MANUFACTURERS
   1. Basis-of-Design Product: 1. The design for systems is based on Cross Aluminum Products, FL-
...
1. ALUMINUM FLUSH PANEL DOORS A. Door Opening Size:
...
1. Joinery to be hairline.
1. Sealants applied on applicable areas.
1. Framing elevations to be identified according to final approved drawings. E. Anchoring:
   1. Appropriate anchoring fasteners to be secured no more than 18 inches apart on entire frame opening.
1. Frame headers to receive no less than 2 anchoring fasteners.
1. Add extra fasteners where hardware and hinge may require more. F. Doorstop:
...
1. To receive weather strip around acting door leafs.
   1. Wool pile:
...
6. INSTALLATION 1. General: 1. Install aluminum work plumb, rigid, properly aligned, and securely fastened in place;
