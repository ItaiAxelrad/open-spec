...
4. Breakaway Device for Power-Operated Doors:
   1. Not more than 50 lbf required for a breakaway door or panel to open.
5. Accessible Interior Doors:
...
8. Activation and safety devices.
9. Include hardware schedule and indicate hardware types, functions, quantities, and locations.
   1. Sample:
...
15. Extruded Bars, Rods, Profiles, and Tubes:
    1. ASTM B 221.
16. Sheet and Plate:
    1. ASTM B 209.
...
17. Structural Shapes, Plates, and Bars:
    1. ASTM A 36/A 36M.
18. Cold-Rolled Sheet and Strip:
    1. ASTM A 1008/A 1008M.
19. Hot-Rolled Sheet and Strip:
...
20. SLIDING AUTOMATIC ENTRANCES
    1. Manufacturers:
       1. Subject to compliance with requirements, provide products by one of the following:
       1. Besam Inc.
21. Dor-O-Matic; an Ingersoll-Rand Company.
22. Horton Automatics; Div. of Overhead Door Corporation.
23. Stanley Access Technologies; Div. of The Stanley Works.
    1. General:
...
27. Carrier Assembly and Overhead Roller Track:
...
33. Electromechanical Operators: Self-contained overhead units, with power opening and spring or power-operated closing mechanism and with checking in both opening and closing cycles.
    1. Mounting:
       1. Concealed.
34. Infrared-Scanner Presence Detector: Self-contained, adjustable infrared presence-sensing device to activate door operator; with metal or plastic housing.
35. Wall Push-Plate Switch: Semiflush, wall-mounted, door control switch; consisting of round or square, flat, stainless-steel push plate with engraved message; and controlling actuator mounted in recessed junction box.
    1. Message:
       1. International symbol of accessibility and "Push to Open."
36. Hardware, General: Heavy duty; in size, number, and type recommended by manufacturer for entrances required. Finish exposed parts to match door finish, unless otherwise indicated.
37. Emergency Breakaway Hardware: Release hardware allows panel to swing out in the direction of egress to a full 90 degrees from any position in the sliding mode. Maximum force to open panel shall be 50 lbf according to ANSI/BHMA A156.10.
38. Deadlocks: Mortise hook bolt with five-ply laminated steel, hook-shaped throw bolt, complying with ANSI/BHMA A156.5, Grade 1 requirements. 1. Door Cylinders: 1. As specified in Division 8 Section "Door Hardware" Door
    Hardware Group 1.
39. Door Card Reader: As specified in Division 8 Section "Door Hardware" Door Hardware
40. Group 2.
41. Push Bars: Surface mounted, aluminum.
42. Compression Weather Stripping: Replaceable, compressible gaskets of molded neoprene or molded PVC. Include bumper-type gaskets at door stops and laps.
43. Prefabrication:
...
1. Set headers, carrier assemblies, tracks, operating brackets, and guides level and true to location with anchorage for permanent support.
1. Install components to drain water passing joints, condensation occurring within framing members, and moisture migrating within system to exterior.
1. Level recesses for recessed thresholds using nonshrink grout.
1. Provide thresholds at exterior doors.
   1. Door Operators: 1. Connect door operators to electrical power distribution system as specified in
...
1. Readjust door operators and controls after repeated operation of completed installation equivalent to 3 days' use by normal traffic (100 to 300 cycles). Lubricate hardware, operating equipment, and other moving parts.
   1. Demonstration: 1. Engage a certified inspector to train Owner's maintenance personnel to adjust, operate, and maintain automatic entrances.
