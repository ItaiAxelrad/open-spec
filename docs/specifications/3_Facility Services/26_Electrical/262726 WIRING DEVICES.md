...
1. 1. Single and duplex receptacles, ground-fault circuit interrupters,
   1. integral
   1. surge
   1. suppression units, and isolated-ground receptacles.
1. 1. Single- and double-pole snap switches and dimmer switches.
1. 1. Device wall plates.
1. 1. Pin and sleeve connectors and receptacles.
1. 1. Floor service outlets, service poles, and multioutlet assemblies.
1. DEFINITIONS
1. EMI:
...
1. Active TVSS Indication:
   1. Visual only with light visible in face of device to indicate device is

"active" or "no longer in service." 3. Identification: 1. Distinctive marking on face of device to denote TVSS-type unit.
...
2. PENDANT CORD/CONNECTOR DEVICES
3. Description:
...
10. SWITCHES
11. Single- and Double-Pole Switches:
...
1. Fluorescent Lamp Dimmer Switches:
...
1. Material for Finished Spaces:
   1. 0.035-inch- thick, satin-finished stainless steel.
1. Material for Unfinished Spaces:
   1. 0.035-inch- thick, satin-finished stainless steel.
1. Material for Wet Locations:
...
1. Wiring Devices Connected to Emergency Power Systems:
   1. Red.
1. TVSS Devices:
   1. Blue.
1. Isolated-Ground Receptacles:
...
1. 1. After installing wiring devices and after electrical circuitry has been energized, test for
   1. proper polarity, ground continuity, and compliance with requirements.
1. 1. Test GFCI operation with both local and remote fault simulations according to
   1. Re
