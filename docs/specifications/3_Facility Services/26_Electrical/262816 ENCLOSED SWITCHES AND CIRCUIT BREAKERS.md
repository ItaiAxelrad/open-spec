...
1.  Dimensioned Outline Drawings of Equipment Unit:
    1. Identify center of gravity and locate and describe mounting and anchorage provisions.
1.  Detailed description of equipment anchorage devices on which the certification is based and their installation requirements.
    1.  Operation and Maintenance Data: 1. For enclosed switches and circuit breakers to include in emergency, operation, and maintenance manuals. In addition to items specified in Division 1
        Section "Closeout Procedures," include the following: 1. Manufacturer's written instructions for testing and adjusting enclosed switches and circuit breakers.
...
1. FUSIBLE AND NONFUSIBLE SWITCHES A. Manufacturers:
...
5. MOLDED-CASE CIRCUIT BREAKERS AND SWITCHES A. Manufacturers:
   1. Eaton Corporation; Cutler-Hammer Products.
6. General Electric Co.; Electrical Distribution & Control Division.
7. Square D/Group Schneider.
...
9. Adjustable Instantaneous-Trip Circuit Breakers:
   1. Magnetic trip element with front- mounted, field-adjustable trip setting.
10. Electronic Trip-Unit Circuit Breakers:
...
15. Application Listing:
    1. Type HACR for heating, air-conditioning, and refrigerating equipment.
16. ENCLOSURES
17. NEMA AB 1 and NEMA KS 1 to meet environmental conditions of installed location.
18. Outdoor Locations:
    1. NEMA 250, Type 3R.
19. Wet Areas:
    1. NEMA 250, Type 4X, stainless steel.
20. Other Wet or Damp Indoor Locations:
    1. NEMA 250, Type 4.
21. Hazardous Areas Indicated on Drawings:
...
1. Verify switch and relay type and labeling verification.
1. Verify rating of installed fuses.
1. Inspect proper installation of type, size, quantity, and arrangement of mounting or anchorage devices complying with manufacturer's certification.
...
"Electrical Supports and Seismic Restraints." 2. Perform each electrical test and visual and mechanical inspection stated in NETA ATS, Section 7.5 for switches and Section 7.6 for molded-case circuit breakers. Certify compliance with test parameters. 3. Correct malfunctioning units on-site, where possible, and retest to demonstrate compliance; otherwise, replace with new units and retest. 06. ADJUSTING

1. Set field-adjustable switches and circuit-breaker trip ranges.
2. CLEANING
3. On completion of installation, vacuum dirt and debris from interiors; do not use compressed air to assist in cleaning.
4. Inspect exposed surfaces and repair damaged finishes.
