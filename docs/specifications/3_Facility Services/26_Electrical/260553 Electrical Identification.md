...
1. Compounded for permanent direct-burial service.
1. Embedded continuous metallic strip or core.
1. Printed legend indicating type of underground line.
...
1. UNDERGROUND-LINE WARNING TAPE A. Tape:
...
1. Tape material and ink shall be chemically inert, and not subject to degrading when exposed to acids, alkalis, and other destructive substances commonly found in soils.
...
1. Prime surfaces using type of primer specified for surface.
1. Apply one intermediate and one finish coat of enamel.
...
1. Apply the following colors to the systems listed below:
   1. Fire Alarm System:
      1. Red.
...
1. Multiple Power or Lighting Circuits in the Same Enclosure:
...
1. Multiple Control and Communication Circuits in the Same Enclosure:
...
1. Access doors and panels for concealed electrical items.
1. Electrical switchgear and switchboards.
1. Electrical substations.
1. Emergency system boxes and enclosures.
1. Disconnect switches.
1. Enclosed circuit breakers.
1. Motor starters.
1. Push-button stations.
1. Contactors.
1. Remote-controlled switches.
1. Dimmers.
1. Control devices.
1. Transformers.
1. Battery racks.
1. Telephone switching equipment.
1. Terminals, racks, and patch panels for voice and data communication and for signal and control functions.
1. Call system master station.
1. TV/audio-monitoring master station.
1. Fire alarm master station or control panel.
1. Security-monitoring master station or control panel.
   26 05 53
