...
6. Certified results of independent laboratory tests for fixtures and lamps for photometric performance. Photometric data shall include candle power distribution curve and table, zonal lumen table and coefficient of utilization table.
...
12. DELIVERY, STORAGE, AND HANDLING OF POLES
...
14. Protection of Metal from Corrosion:
...
6. Single-Lamp Ballasts:
   1. Minimum starting temperature of minus 40°C.
7. Open-circuit operation will not reduce average life.
8. High-Pressure Sodium Ballasts:
...
10. Mount control components internal to ballast.
11. Connect to ballast with tap so quartz lamp operates at 120V.
    1. Lamps:
...
12. Metal-Halide Color Temperature and Minimum Color-Rendering Index:
    1. 3600 K and 70 CRI, unless otherwise indicated.
13. High Pressure Sodium Color Temperature and Minimum Color Rendering Index:
    1. 2200K and 60 CRI, unless otherwise indicated.
14. Fluorescent Color Temperature and Minimum Color Rendering Index:
    1. 3500K and 85 CRI, unless otherwise indicated.
15. LUMINAIRE SUPPORT COMPONENTS
    1. Description:
...
23. Shape: 1. Round, tapered for over 20’ height or taller, round straight for under 20’ height.
    1. Steel Mast Arms:
    ...
    1. Brackets for Luminaires: 1. Detachable, with pole and adapter fittings. Adapter fitting welded to pole and bracket, then bolted together with stainless-steel bolts.
...
[a.] Color: As selected by Architect from manufacturer's full range. 5. ACCESSORIES
...
1. Nonmetallic polycarbonate plastic or reinforced fiberglass cover, [Insert color to match pole,] that when mounted results in NEMA 250, Type [3R] [4X] enclosure.
1. With cord opening.
1. With lockable hasp and latch that meets OSHA lockout and tagout requirements.
1. Minimum 1800-W transformer, protected by replaceable fuses, mounted behind access cover.
...
1. Finish for Parts Exposed to View:
...
1. Mount pole to foundation with leveling nuts, and tighten top nuts to torque level recommended by pole manufacturer.
1. Secure poles level, plumb, and square.
1. Grout void between pole base and foundation. Use nonshrinking or expanding concrete grout firmly packed in entire void space.
1. Use a short piece of 1/2-inch- (13-mm-) diameter pipe to make a drain hole through grout. Arrange to drain condensation from interior of pole.
   1. Luminaire Attachment:
