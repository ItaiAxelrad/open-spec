...
3. Construction requirements for concrete bases. B. Related Sections include the following:
...
7. Nonmetallic slotted support systems.
   1. Shop Drawings:
...
8. Steel slotted channel systems. Include Product Data for components.
9. Nonmetallic slotted channel systems. Include Product Data for components.
10. Equipment supports. C. Welding certificates.
11. QUALITY ASSURANCE
    1. Welding: 1. Qualify procedures and personnel according to AWS D1.1/D1.1M, "Structural Welding
       Code - Steel."
...
1. Fitting and Accessory Materials:
...
1. APPLICATION
   ...
   1. Maximum Support Spacing and Minimum Hanger Rod Size for Raceway: 1. Space supports for
...
1. SUPPORT INSTALLATION
   1. Comply with NECA 1 and NECA 101 for installation requirements except as specified in this
      Article.
   1. Raceway Support Methods: 1. In addition to methods described in NECA 1, EMT, IMC, and RMC
...
1. Instead of expansion anchors, powder-actuated driven threaded studs provided with lock washers and nuts may be used in existing standard-weight concrete 4 inches thick or greater. Do not use for anchorage to lightweight-aggregate concrete or for slabs less than 4 inches thick.
1. To Steel:
...
1. Apply paint by brush or spray to provide minimum dry film thickness of 2.0 mils.
   ...
   1. Galvanized Surfaces: 1. Clean welds, bolted connections, and abraded areas and apply galvanizing-repair paint to comply with ASTM A 780.
