...
1. COMPUTER SOFTWARE PROGRAM REQUIREMENTS A. Comply with IEEE 399.
...
1. Arcing faults.
1. Simultaneous faults.
1. Explicit negative sequence.
1. Mutual coupling in zero sequence.
...
1. Branch circuit panelboard
   1. Calculations to verify interrupting ratings of overcurrent protective devices shall comply with
      IEEE 141 and IEEE 242 and the following: 1. Low-Voltage Circuit Breakers: 1. IEEE 1015 and IEEE C37.50.
1. Low-Voltage Fuses:
   1. IEEE C37.46.
1. Circuit Breakers:
   1. IEEE C37.13.
...
1. Impedance of utility service entrance.
1. Electrical distribution system diagram showing the following:
...
1. Data sheets to supplement electrical distribution system diagram, cross-referenced with tag numbers on diagram:
...
1. Device shall protect transformer according to IEEE C57.12.00, for fault currents. F. Motors served by voltages more than 600 V shall be protected according to IEEE 620.
...
1. Completed data sheets for setting of overcurrent protective devices.
1. OVERCURRENT PROTECTIVE DEVICE SETTING
1. Testing:
...
1. Adjust devices according to recommendations in Chapter 7, "Inspection and Test
