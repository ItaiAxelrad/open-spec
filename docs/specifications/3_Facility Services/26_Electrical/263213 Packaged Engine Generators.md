...
1.  If the engine has not started within 15 seconds, the control system is to: 1. De-energize the start contactor 1. Lock the circuit out 1. Energize the Engine Fail Alarm
