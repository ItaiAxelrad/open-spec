...
5. Accessories
   ...
   2. Single sphere style stainless steel construction.
   3. Pressure rating: 25 PSIG.
   4. Temperature Rating: 250 Degrees Fahrenheit.
   5. Maximum Compression: 1-3/4 IN.
   6. Maximum Extension: 1/4 IN.
   7. Joint: As specified for individual piping system.
...
50. Pressure Testing:
    ...
    4. Hydrostatic pressure testing methodology: 1. General: 1. All joints, including welds, are to be left exposed for examination during the test. 2. Provide additional temporary supports for piping systems designed for vapor or gas to support the weight of the test water. 3. Provide temporary restraints for expansion joints for additional pressure load under test. 4. Isolate equipment in piping system with rated pressure lower than pipe test pressure. 5. Do not paint or insulate exposed piping until successful performance of pressure test.
