...
1. PREPARATION
   ...
   1. Fill Under Asphalt or Concrete Paving:
      1. Type B fill, to subgrade elevation, compacted in six inch maximum lifts with each lift compacted to 95 percent.
         312323.13
   1. _Since the requirement that work complies with the CBC applies to all sections, the requirement is stated once in Section 010000 – General Requirements._ [↑](#footnote-ref-1)
