...
1. Materials
   ...
   1. 18-inch to 27-inch inside diameter: ASTM F 679, Wall thickness T-1
   1. Joints: ASTM D 3212, rubber gasketed bell and spigot type with integral bell.
2. Cleanouts:
...
5. Lamping:
   ...
   1. The Contractor shall correct any deficiencies noted such as poor alignment, displaced pipe, debris in the pipe, or any other defects. Tests will be repeated after completion of repair and backfill.
6. Leakage:
   ...
   1. The length of time for a 0.5 psig pressure drop from 3.5 psig to 3.0 psig shall not be less than the following table:
   1. Pipe Diameter _(inches)_
   1. 100’
   1. 150’
   1. 200’
   1. 250’
...
7. Deflection testing may be required if the Engineer suspects excessive pipe deflection or if the Contractor’s pipe bedding procedures, in particular, tamping and compaction of the bedding, are questionable in the opinion of the Engineer.
...
8. Video Inspection:
   ...
   1. No more than 48 hours prior to the video inspection, the contractor shall clean and flush all new sewer mains and manholes.
   1. The video inspection must be performed with a color video camera which is track driven and sits on the bottom of the pipe for proper orientation and shall have an articulating camera to allow for inspection of service taps.
   1. The video must be with encoded distance totalizer, from and to manhole numbers, pipe material, size and inspection date.
   1. The video log shall include:
   ...
   1. The maximum amount of standing water allowed in any pipe or manhole shall be 3 percent of the pipe’s diameter or 1/2 inch whichever is smaller.
