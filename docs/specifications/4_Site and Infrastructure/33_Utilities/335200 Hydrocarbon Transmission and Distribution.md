...
1. SCOPE
   ...
   9. Design Criteria
   10. Welder Qualifications
   11. Natural Gas Service
...
1. _Use the following paragraph for all building service piping and steam piping less than or equal to 15 psig._
...
1. _Use the following paragraph when the project has any high pressure steam piping (greater than 15 psig)._
...
1. _Welder certifications are required to be renewed every three years. If qualification papers are needed on a project, verify that they are current._
...
1. _List the contact person at the gas utility along with their telephone number and address so the contractor can properly schedule this work._
1. _Verify whether or not a gas meter needs a concrete pad. If it does, coordinate this with the architect so that the general contractor installs it._
...
1.  _This requirement is based on NFPA Standards.._
...
1.  FUEL OIL
1.  _This specification to be used for aboveground installations. See next paragraph for underground systems._
...
1.  _Teflon tape is not acceptable._
...
1.  _Refer to NFPA 30-1990, 3-3.4 for additional commentary on use of copper, aluminum or brass in fuel oil piping systems._
...
1.  _Teflon tape is acceptable on natural gas lines._
