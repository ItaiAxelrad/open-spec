...
* ***Section 22 13 00 – Facility Sanitary Sewerage*
    1. and clearly define party responsible for testing of the respective utility on the Drawings.
1. 
## General
 ...
 ***Note to the designer: Determine if this work will impact other related work and revise these specifications accordingly to only include those Sections that apply to the project.*
...
1. REFERENCE STANDARDS
   ...
   1. C151/ANSI A21.53 Standard for Ductile Iron Pipe, Centrifugally Cast 
...
* Castings and Covers
   1. Provide wastewater diversion and pumping plan.
   1. Provide reports documenting all required testing and televising. testing results for the project to the DFD Project Representative and the AE within 48 hours of completing the individual tests.
1. PROVISIONS FOR FUTURE WORK
1. *Note to the designer:
      1. Describe any specific provisions required to accommodate future sanitary sewer work.*
...
1. PVC PIPE
   ...
   1. PVC fittings shall be same joint type and SDR as connecting PVC sanitary sewer pipe.
1. HDPE PIPE
1. *Note to the designer:
      1. Verify the necessary Dimension Ratio (DR) based on site specific conditions including pipe diameter, depth and soil type.*
...
1. DROP MANHOLES
   1. Note to Designer:
      1. Determine drop manhole configuration and manufacturing methods.
...
1. Bedding/utility Cover
   ...
   1. Provide *[Crushed Stone Bedding]* shall be used for both bedding and utility cover in accordance with the applicable requirements of Section 31 23 16.13 – Trenching.
   ...
   1. A minimum of 8” of compacted *[Crushed Stone Bedding]* shall be placed below manhole base.
   1. A minimum of 6” of compacted *[Crushed Stone Bedding]* shall be placed below the sanitary sewer pipe and 12” of cover material shall be placed over the sanitary sewer pipe (both measured at the bell of the pipe). 
1. MANHOLES
